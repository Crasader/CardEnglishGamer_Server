...
import org.kteam.dao.AppointmentMapper;
...
import org.kteam.service.AppointmentService;
...
public class AppointmentServiceImpl implements AppointmentService {
  ...
  @Transactional(rollbackFor = {Exception.class})
    ...
    //利用google guava判空
    Preconditions.checkNotNull(record.getUserNumber(), "用户号不能为空");
    Preconditions.checkNotNull(record.getBookId(), "图书编号不能为空");
